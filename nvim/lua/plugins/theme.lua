-- ===============================================================
-- Theme — GitHub Dark Dimmed colorscheme + highlight overrides
-- ===============================================================
-- Loaded immediately. All italic styles disabled for a clean look.
-- Custom highlights for statusline, floating windows, and Telescope.
...
-- Floating windows (LSP hover, signature help, etc.)
